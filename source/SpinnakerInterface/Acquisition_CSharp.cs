...
//                {
//                    Console.WriteLine("Working with a GigE camera. Attempting to disable heartbeat before continuing...\n\n");
//                    IBool iGEVHeartbeatDisable = nodeMap.GetNode<IBool>("GevGVCPHeartbeatDisable");
//                    if (iGEVHeartbeatDisable is null || !iGEVHeartbeatDisable.IsWritable)
//                    {
//                        Console.WriteLine("Unable to disable heartbeat on camera. Continuing with execution as this may be non-fatal...");
//                    }
//                    else
//                    {
//                        iGEVHeartbeatDisable.Value = true;
//                        Console.WriteLine("WARNING: Heartbeat on GigE camera disabled for the rest of Debug Mode.");
//                        Console.WriteLine("         Power cycle camera when done debugging to re-enable the heartbeat...");
//                    }
//                }
//                else
//                {
...
//                if (iAcquisitionMode is null || !iAcquisitionMode.IsWritable)
//                {
...
//                if (iAcquisitionModeContinuous is null || !iAcquisitionMode.IsReadable)
//                {
